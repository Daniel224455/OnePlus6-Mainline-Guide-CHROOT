...
chroot rootdir apt install -y bash-completion sudo ssh nano cloud-init- wireless-regdb- $1
...
cp /home/daniel/ubuntu-oneplus-enchilada/*-oneplus-enchilada.deb rootdir/tmp/
...
#chroot rootdir grub-mkconfig -o /boot/grub/grub.cfg
